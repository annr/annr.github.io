...
__Profiler.prototype.buttonCss = 'float:right;background:none;border-radius:5px;padding:3px 10px' + ';font-size:12px;line-height:130%;width:auto;margin:-7px -10px 0 0;cursor:pointer';
